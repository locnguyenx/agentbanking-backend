...
import com.agentbanking.rules.application.usecase.AuditLogServiceImpl;
...
public class RulesAuditController {

    private final AuditLogServiceImpl auditLogService;

    public RulesAuditController(AuditLogServiceImpl auditLogService) {
