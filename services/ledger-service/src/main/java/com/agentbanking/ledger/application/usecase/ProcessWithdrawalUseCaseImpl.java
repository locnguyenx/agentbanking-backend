...
public class ProcessWithdrawalUseCaseImpl implements ProcessWithdrawalUseCase {
    ...
    public ProcessWithdrawalUseCaseImpl(com.agentbanking.ledger.domain.service.LedgerService ledgerService) {
    ...
    public Map<String, Object> processWithdrawal(UUID agentId, BigDecimal amount,
        ...
        return ledgerService.processWithdrawal(agentId, amount, customerFee, agentCommission,
