...
public class LedgerService {
    ...
    public Map<String, Object> processWithdrawal(UUID agentId, BigDecimal amount, 
        ...
        var transaction = new TransactionRecord(
                ...
                idempotencyKey,
                agentId,
                transactionType != null ? TransactionType.fromFrontend(transactionType) : TransactionType.CASH_WITHDRAWAL,
                amount,
                customerFee,
                agentCommission,
                bankShare,
    ...
    public Map<String, Object> processDeposit(UUID agentId, BigDecimal amount, 
        ...
        var transaction = new TransactionRecord(
                ...
                idempotencyKey,
                agentId,
                transactionType != null ? TransactionType.fromFrontend(transactionType) : TransactionType.CASH_DEPOSIT,
                amount,
                customerFee,
                agentCommission,
                bankShare,
