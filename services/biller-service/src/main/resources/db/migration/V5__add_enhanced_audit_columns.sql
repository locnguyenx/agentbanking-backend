...
ADD COLUMN IF NOT EXISTS service_name VARCHAR(50) NOT NULL DEFAULT 'biller-service',
...
ALTER TABLE audit_logs ALTER COLUMN service_name SET DEFAULT 'biller-service';