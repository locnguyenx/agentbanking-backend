...
Reference BDD spec for Given-When-Then test scenarios; fall back to BRD/user stories.
...
**Specs loction:** `docs/superpowers/specs/`
...
Check for BDD spec first (Gherkin scenarios drive TDD tests); if missing, flag for brainstorming skill.
...
Write frontend TDD steps similar to step1-step5 of backend above.
